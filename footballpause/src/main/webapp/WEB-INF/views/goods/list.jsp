				...
				<div class="panel-body">
					<table class="table table-striped table-bordered table-hover">
						...
						<c:forEach items="${list }" var="list">
							<tr>
								<td><c:out value="${list.g_no }" /></td>
								<td><a class='move' href='<c:out value="${list.g_no }"/>'>
								<c:out value="${list.g_name }" />
								<b>[ <c:out value="${list.g_no }" /> ]</b></a></td>
								<td><c:out value="${list.g_league }" /></td>
								<td><c:out value="${list.g_team }" /></td>
								<td><c:out value="${list.g_brand }" /></td>
								<td><c:out value="${list.g_price }" /></td>
								<td><c:out value="${list.g_category }" /></td>
								<td><c:out value="${list.g_stock }" /></td>
								<td><c:out value="${list.g_fileName }" /></td>
								<td><fmt:formatDate pattern="yyyy-MM-dd"
										value="${list.g_regdate }" /></td>
							</tr>
						</c:forEach>
					</table>
		...
		$(document).ready(
				function() {
					...
					$(".move").on("click",function(e) {
						e.preventDefault();
					actionForm.append("<input type='hidden' name='g_no' value='"+
							$(this).attr("href")+"'>");
