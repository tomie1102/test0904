...
<body>
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label>이름</label> <input class="form-control" name='g_name'
							value='<c:out value="${list.g_name }"/>' readonly="readonly">
					</div>

					<div class="form-group">
						<label>리그</label> <input class="form-control" name='g_league'
							value='<c:out value="${list.g_league }"/>' readonly="readonly">
					</div>

					<div class="form-group">
						<label>팀</label> <input class="form-control" name='g_team'
							value='<c:out value="${list.g_team }"/>' readonly="readonly">
					</div>
					
					<div class="form-group">
						<label>브랜드</label> <input class="form-control" name='g_brand'
							value='<c:out value="${list.g_brand }"/>' readonly="readonly">
					</div>
					
					<div class="form-group">
						<label>가격</label> <input class="form-control" name='g_price'
							value='<c:out value="${list.g_price }"/>' readonly="readonly">
					</div>
					<div class="form-group">
						<label>카테고리</label> <input class="form-control" name='g_category'
							value='<c:out value="${list.g_category }"/>' readonly="readonly">
					</div>
					<div class="form-group">
						<label>재고</label> <input class="form-control" name='g_stock'
							value='<c:out value="${list.g_stock }"/>' readonly="readonly">
					</div>
					<div class="form-group">
						<label>파일</label> <input class="form-control" name='g_fileName'
							value='<c:out value="${list.g_fileName }"/>' readonly="readonly">
					</div>

					<button data-oper='modify' class="btn btn-default"
						onClick="location.href='/goods/modify?g_no=<c:out value="${list.g_no }"/>'">수정하기</button>
					<button data-oper='list' class="btn btn-info"
						onClick="location.href='list'">글목록</button>

					<%-- <form id='operForm' action="/goods/modify" method="get">
						<input type='hidden' id='' name='bno'
							value='<c:out value="${list.bno}"/>'> <input
	...
	<script>
		$(document)
				.ready(
						function() {
							var bnoValue = '<c:out value="${goods.g_no}"/>';
							var replyUL = $(".chat");
				...
				.ready(
						function() {
							...
							(function() {
								...
								var g_no = '<c:out value="${goods.g_no}"/>';
