...
//	private TeamService tservice;
	 ...
	 * RedirectAttributes rttr) { log.info("remove : " + bno); if
	 * (service.remove(bno)) { rttr.addFlashAttribute("result", "success"); } return
	 * "redirect:/board/list"; }
	 */
	@PostMapping("/remove")
...
//	 @GetMapping("/team") public void list(Model model) { log.info("team");
//	 model.addAttribute("team",tservice.getList()); }
